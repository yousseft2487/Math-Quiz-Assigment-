...
# Greets the player  
statement_generator("Hello, and welcome to the Multiplaction Quizz.", "*", 3)
...
# comp_choice = 2 
    ...
    user_answer = int_check("What is {} x {} ? ".format(comp_choice, user_choice))
    ...
    if end_game != "" or rounds_played == highest:
        break
