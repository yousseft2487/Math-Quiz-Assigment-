...
def instructions():
        ...
        print()
        print("Than it'll ask you a series of questions of the number of your choice times 2 - 12.")
        return""
...
def int_check2(question, low=2, high=12):
...
# comp_choice = 2 
    ...
    user_answer = int_check2("What is {} x {} ? ".format(comp_choice, user_choice))
